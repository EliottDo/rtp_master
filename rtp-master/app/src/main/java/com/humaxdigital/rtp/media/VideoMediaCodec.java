package com.humaxdigital.rtp.media;
...
import com.humaxdigital.rtp.screen.Constant;
        ...
        try
        {
            while(isRun){
                ...
                while (outputBufferIndex >= 0){
                    ...
                    Log.d("Lampard", "FLAG " + mBufferInfo.flags);
//                    Log.d("Lampard", "raw data " + Utils.bytesToHex(outData));
